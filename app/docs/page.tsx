...
const t: Record<Lang, {
  ...
  en: {
    ...
    cards: [
      ...
      { title: "MCP + x402", desc: "14-tool MCP server lets any AI assistant interact with the protocol. Paid tools use x402 USDC." },
    ],
    ...
    archRows: [
      ...
      ["AI Interface", "MCP server (14 tools) + x402 USDC payments"],
  ...
  es: {
    ...
    cards: [
      ...
      { title: "MCP + x402", desc: "Servidor MCP con 14 herramientas para que cualquier IA interactúe con el protocolo. Pagos en USDC." },
    ],
    ...
    archRows: [
      ...
      ["Interfaz IA", "Servidor MCP (14 herramientas) + pagos x402 USDC"],
  ...
  pt: {
    ...
    cards: [
      ...
      { title: "MCP + x402", desc: "Servidor MCP com 14 ferramentas para qualquer IA interagir com o protocolo. Pagamentos em USDC." },
    ],
    ...
    archRows: [
      ...
      ["Interface IA", "Servidor MCP (14 ferramentas) + pagamentos x402 USDC"],
  ...
  zh: {
    ...
    cards: [
      ...
      { title: "MCP + x402", desc: "14 个工具的 MCP 服务器，让任何 AI 助手与协议交互。付费工具使用 x402 USDC。" },
    ],
    solves: "Agio 解决了什么",
    ...
    archRows: [
      ...
      ["AI 接口", "MCP 服务器（14 个工具）+ x402 USDC 支付"],
