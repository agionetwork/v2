...
const t: Record<Lang, {
  ...
  en: {
    ...
    notes: "Notes",
    notesList: [
      "Rate-limited per IP at the edge. Treat 429s as a backoff signal.",
  ...
  es: {
    ...
    notes: "Notas",
    notesList: [
      "Rate-limited por IP en el edge. Trata los 429 como señal de backoff.",
  ...
  pt: {
    ...
    notes: "Notas",
    notesList: [
      "Rate-limited por IP no edge. Trate 429s como sinal de backoff.",
