...
const t: Record<Lang, {
  ...
  en: {
    ...
    forecloseDesc: "(lender) seize collateral when ratio drops below 120%",
  ...
  es: {
    ...
    forecloseDesc: "(prestamista) confiscar la garantía cuando el ratio cae por debajo del 120%",
  ...
  pt: {
    ...
    forecloseDesc: "(credor) confiscar a garantia quando a taxa cai abaixo de 120%",
    rescindLabel: "Rescindir",
  ...
  zh: {
    ...
    forecloseLabel: "清算",
    forecloseDesc: "（出借方）当比率降至 120% 以下时没收抵押品",
    rescindLabel: "撤销",
