...
function SocialFiContent({ children }: { children: ReactNode }) {
...
export default function SocialFiLayout({ children }: { children: ReactNode }) {
  ...
  return <SocialFiContent>{children}</SocialFiContent>
}
